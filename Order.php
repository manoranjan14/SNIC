    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                 <form role="form" action="payment.php?ProductID=<?php echo $ProductID; ?>&CustomerID=<?php echo $CustomerID; ?>" method="POST">
					...
					<div class="form-group">
						...
						<input type="number" name="ProductSize" class="form-control" id="ProductSize" min="5" max="12" required>
					</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy;M@gmail.com</p>
                </div>
            </div>
        </div>
    </footer>
