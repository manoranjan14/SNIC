        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <?php echo '<li><a><strong>'.$Username.'</strong></a></li>'; ?>
		...
		<div class="col-sm-4 col-lg-4 col-md-4">
             <div class="thumbnail">
                ...
                <div class="caption">
					...
					<p><strong>Price: '.$Rows[5].'.00</strong></p>
                </div>
				<center><a onclick="addToCartOnclick('.$Rows[0].');" href="#"  style="margin-bottom: 5px;" class="btn btn-primary">Buy Now</a></center>
            </div>
        </div>
		';
		}?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <a href="#" onclick="ManagementOnclick();">Admin</a>|
					<?php if($Username == null){echo '<a href="register.php?ActionType=Register">Register</a>';} ?>|
					<?php if($Username == null){echo '<a href="Login.php?Role=User">Login</a>';} ?>
					</strong><br>
